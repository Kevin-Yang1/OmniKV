...
class CacheCraftPipeline:
    ...
    def _prepare_prompt_template(self, chunks: List[str], question: str, prompt_template: str = None, system_prompt: str = None):
        """
    ...
    def generate(self, chunks: List[str], question: str, prompt_template: str = None, system_prompt: str = None):
        ...
        chunks, suffix_part = self._prepare_prompt_template(chunks, question, prompt_template, system_prompt)
